 ...
 */
/* Hi Lo Game.  Guess a number between 1 -100. Random number generated by computer. Computer play against self with max 50 guesses */
...
function hiLo(MN, GN)
{
    for(var i=0; i < 51; i++) {                           //say MN = 30   GN = 60
        if (GN === MN) {
            console.log("Yay, the guess is correct!");
            i = 1000;
        }
        else if (GN < MN) {
